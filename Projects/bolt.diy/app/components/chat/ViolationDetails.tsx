  ...
  return (
    <div className="text-xs bg-bolt-elements-background-depth-3 rounded px-2 py-1.5 flex items-start gap-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        {location && <span className="text-bolt-elements-textTertiary ml-2">({location})</span>}
        {violation.autoFixable && <span className="ml-2 text-green-400 text-[10px]">auto-fixable</span>}
      </div>
    </div>
  );
}
