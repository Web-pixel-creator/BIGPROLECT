...
const COMPONENT_KEYWORDS: Record<string, string[]> = {
  ...
  list: ['list', 'listing', 'items', 'bullet points', 'список', 'перечень', 'пункты'],
  ...
  tabs: ['tabs', 'tab', 'tabbed', 'tab panel', 'tab navigation', 'вкладки', 'табы', 'переключатели'],
  accordion: [
    'accordion',
    'collapsible',
    'expandable',
  ...
  tooltip: ['tooltip', 'hint', 'popover', 'info bubble', 'подсказка', 'тултип', 'всплывающая подсказка'],
  dropdown: ['dropdown', 'select', 'menu dropdown', 'combobox', 'выпадающий список', 'дропдаун', 'селект'],
  ...
  button: ['button', 'btn', 'cta button', 'action button', 'submit', 'кнопка', 'кнопки', 'батон'],
  input: [
    'input',
    'text field',
    'text input',
  ...
  checkbox: ['checkbox', 'check', 'toggle', 'switch', 'чекбокс', 'галочка', 'переключатель', 'свитч'],
  ...
  mask: ['mask', 'svg mask', 'clip', 'cutout', 'shape mask', 'маска', 'вырез', 'контур', 'обрезка'],
  evervault: [
    'evervault',
    'matrix',
    'encryption',
  ...
  dot: ['dot', 'dot pattern', 'dot background', 'polka dots', 'dotted', 'точки', 'точечный фон', 'узор из точек'],
  wave: ['wave', 'wavy', 'wave animation', 'ocean', 'ripple', 'волна', 'волнистый', 'рябь', 'волновой эффект'],
  blur: [
    'blur',
    'blur effect',
    'glassmorphism',
  ...
  plasma: ['plasma', 'liquid', 'fluid', 'organic', 'morphing', 'плазма', 'жидкость', 'органический', 'морфинг'],
  hyperspeed: [
    'hyperspeed',
    'warp',
    'speed lines',
  ...
  lightning: ['lightning', 'thunder', 'electric', 'bolt', 'storm', 'молния', 'гром', 'электричество', 'шторм'],
  magnet: ['magnet', 'magnetic', 'attract', 'pull', 'magnet effect', 'магнит', 'магнитный', 'притяжение'],
  pixel: [
    'pixel',
    'pixelated',
    'pixel art',
  ...
  ribbon: ['ribbon', 'ribbons', 'flowing', 'silk', 'fabric', 'лента', 'ленты', 'шёлк', 'ткань'],
  metaball: [
    'metaball',
    'metaballs',
    'blob',
  ...
  counter: ['counter', 'count up', 'count down', 'number animation', 'odometer', 'счётчик', 'отсчёт', 'анимация чисел'],
  dock: ['dock', 'macos dock', 'taskbar', 'app dock', 'icon bar', 'док', 'панель приложений', 'док-панель'],
  masonry: [
    'masonry',
    'pinterest',
    'grid layout',
  ...
  stack: ['stack', 'card stack', 'stacked', 'layered', 'pile', 'стопка', 'стек карточек', 'слои'],
  tilt: [
    'tilt',
    'tilt effect',
    '3d tilt',
  ...
  fluid: ['fluid', 'liquid', 'water', 'flow', 'smooth', 'жидкий', 'вода', 'поток', 'плавный'],
  lanyard: ['lanyard', 'badge', 'id card', 'hanging', 'swing', 'бейдж', 'карточка', 'висящий', 'качающийся'],
  stepper: ['stepper', 'steps', 'wizard', 'progress steps', 'multi step', 'степпер', 'шаги', 'мастер', 'пошаговый'],
  ...
  light: ['light', 'light mode', 'light theme', 'white', 'bright', 'светлый', 'светлая тема', 'белый', 'яркий'],
  modern: ['modern', 'contemporary', 'trendy', 'fresh', 'new', 'современный', 'модерн', 'трендовый', 'свежий'],
  minimal: ['minimal', 'minimalist', 'simple', 'clean', 'basic', 'минимал', 'минималистичный', 'простой', 'чистый'],
  elegant: [
    'elegant',
    'luxury',
    'premium',
